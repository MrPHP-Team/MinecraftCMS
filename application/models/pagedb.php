...
class PageDB extends CI_Model {
	...
	function install() {
		...
		#Default start page
		$this->db->query("INSERT INTO `pages` (`id`, `name`, `content`, `ord`, `status`) VALUES (NULL, 'start', '<p>Обычная стартовая страницы</p>', '1', '1');");
		$this->db->query("INSERT INTO `widgets` (`id`, `title`, `content`, `ord`) VALUES (NULL, 'Widget', 'Измени это в админке', '1');");
	}
}
